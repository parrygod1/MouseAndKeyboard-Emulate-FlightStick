...
if is_dcs_active():
	if active:
		...
		#firing modes
		if thorttle_enable and not freeLookHold and mouse.wheelUp and v.z>-15000:
			v.z-=1500

		if thorttle_enable and not freeLookHold and mouse.wheelDown and v.z<15000:
			v.z+=1500
